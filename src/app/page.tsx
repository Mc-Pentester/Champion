        ...
        <div className="max-w-md w-full">
          ...
          <div className="bg-white rounded-lg shadow-xl p-8">
            ...
            <div className="space-y-4">
              <Link href="/auth/signin" className="block w-full bg-indigo-600 text-white py-3 rounded-lg hover:bg-indigo-700 transition-colors text-center font-semibold">
                Se connecter
              </Link>
              <Link href="/auth/signup" className="block w-full bg-gray-200 text-gray-800 py-3 rounded-lg hover:bg-gray-300 transition-colors text-center font-semibold">
                S&apos;inscrire
              </Link>
            </div>
          </div>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-md p-4 mb-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="font-semibold text-gray-800">Bienvenue, {(session as any).user?.name || (session as any).user?.email}!</p>
              <p className="text-sm text-gray-600">Niveau: 1 | XP: 0 | Série: 0</p>
            </div>
            <div className="text-right">
              <p className="text-sm text-gray-600">Rôle: {(session as any).user?.role}</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-6">
          <Link href="/game/quiz" className="bg-gradient-to-br from-green-400 to-green-600 text-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow block">
